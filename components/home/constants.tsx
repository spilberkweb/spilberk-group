...
export const h2StyleLight: React.CSSProperties = {
  fontSize: "clamp(32px, 6vw, 46px)",
  fontWeight: 800,
  lineHeight: 1.15,
  marginBottom: 20,
...
export const sectionContainer: React.CSSProperties = {
  maxWidth: 1120,
  margin: "0 auto",
  padding: "clamp(50px, 8vw, 90px) clamp(20px, 5vw, 36px)",
};
export const kpi: React.CSSProperties = {
  background: "#FFFFFF",
...
export const getBrands = (t: any) => [
  {
    ...
    logo: (c: string) => (
      <img
        src="/spilberk-logo-white.png"
        alt="SPILBERK"
        style={{ height: 26, opacity: 0.5 }}
      />
    ),
    stats: [
      { v: "2,6+", u: "mld CZK" },
