...
export const bgLight = "#F4F4F5";
export const textDark = "#0A0428";
export const border = "rgba(255,255,255,0.12)";
export const borderLight = "rgba(0,0,0,0.15)";
export const muted = "rgba(255,255,255,0.45)";
export const faint = "rgba(255,255,255,0.28)";

export const label: React.CSSProperties = { fontSize: 13, textTransform: "uppercase", letterSpacing: 3.5, color: gold, fontWeight: 700, marginBottom: 12, display: "block" };
export const h2Style: React.CSSProperties = { fontSize: "clamp(32px, 6vw, 46px)", fontWeight: 800, lineHeight: 1.15, marginBottom: 20, color: "white" };
export const h2StyleLight: React.CSSProperties = { fontSize: "clamp(32px, 6vw, 46px)", fontWeight: 800, lineHeight: 1.15, marginBottom: 20, color: textDark };
